                ...
                <ul class="list-unstyled navbar__list">
                    <li class="active has-sub">
                        <a class="js-arrow" href="{{ route('post.index') }}">
                            <i class="fas fa-tachometer-alt"></i>All posts</a>


                    </li>
                    <li>
                        <a href="{{ route('post.create') }}">
                            <i class="fas fa-chart-bar"></i>create post</a>
                    </li>
                    <li>
                        <a href="{{ route('tags.index') }}">
                            <i class="fas fa-chart-bar"></i>all tag</a>
                    </li>
                    <li>
                        <a href="{{ route('tags.create') }}">
                            <i class="fas fa-chart-bar"></i>create tag</a>
                    </li>
                </ul>
            </nav>
        </div>
